    ...
    $("#btnAdd").click(function () {
        $("#publisherAddForm").validate({
            ...
            submitHandler: function (form) {
                let url = "/cruddemo/biblioteca/editoriales?accion=crear";
...
function viewDetailsPublisher(button) {
    ...
    let url = "/cruddemo/biblioteca/editoriales?accion=verDetalles";
    $.ajax({
        url: url,
        method: "GET",
...
function disablePublisher(button) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            let url = "/cruddemo/biblioteca/editoriales?accion=deshabilitar";
            let publisherId = $(button).data("publisherId");
            $.ajax({
                url: url,
                method: "GET",
...
function getAllPublishers() {
    let url = "/cruddemo/biblioteca/editoriales?accion=listar";
