...
function viewDetailsBook(button) {
    let url = "/biblioteca/libros?accion=buscar";
...
// function fnDeactivateGender(button) {
//     let gender = $(button).data("genderName");
//     Swal.fire({
//         title: "¿Estás seguro que quieres desactivar el género literario: " + gender + " ?",
